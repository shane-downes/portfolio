...
export const ProjectOverviewAlternate = ({
  ...
  return (
    <div className="flex">
      <div className="relative flex flex-col gap-[1.6vw] border-l-[1px] border-b-[1px] border-slate-300  dark:border-gray-700 lg:p-[2.6vw]">
        <Image className="h-[28vw] w-[97vw]" src={mockup} alt="Frumo App" />
      </div>
      <div className="flex flex-col justify-between border-l-[1px] border-b-[1px] border-slate-300 dark:border-gray-700 lg:pl-[2.6vw] lg:pb-[2.6vw] lg:pt-[2vw] lg:pr-[15vw]">
        <ProjectSummary
          title={project.title}
